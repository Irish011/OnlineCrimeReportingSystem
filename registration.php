     ...
     function f1()
        {
            ...
            var sta6=document.getElementById("elec").required;
  ...
  var x4=sta4.indexOf(' ');
    ...
    document.getElementById("aadh").focus();
      alert("Space Not Allowed");
          ...
          document.getElementById("elec").focus();
          alert("Please Select");
        }
        else if(sta5!="" && x5>=0){
...
<div class="video" style="margin-top: 5%"> 
	<div class="center-container">
		 <div class="bg-agile">
          ...
          <p style="color:#dfdfdf">Election ID &nbsp<input type="radio"  name="pass" minlength="10" maxlength="10" required pattern="[123456789][0-9]{11}" id="elec" onfocusout="f1()"/></p>
          <p style="color:#dfdfdf">Aadhar Number&nbsp<input type="radio"  name="pass" minlength="10" maxlength="10" required pattern="[123456789][0-9]{11}" id="elec" onfocusout="f1()"/></p>
					<p style="color:#dfdfdf">Passport Number &nbsp<input type="radio"  name="pass" minlength="6" maxlength="16" required pattern="[123456789][0-9]{11}" id="elec" onfocusout="f1()"/></p>
          <input type="text"  name="aadhar_number" placeholder="" minlength="12" maxlength="12" required pattern="[123456789][0-9]{11}" id="aadh" onfocusout="f1()"/>
