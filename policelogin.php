...
<body style="color: black;background-image: url(s3.jpg);background-size: 100%;background-repeat: no-repeat;">
    ...
    <div class="container">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
           ...
           <li class="active"><a href="policelogin.php">Incharge Login</a></li>
        </ul>
    </div>
  </div>
 </nav>
 ...
 <div class="box">
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"  ><h1 style="color:black; font-weight: 750;">Police Id</h1></label>
