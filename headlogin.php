...
?> <style>
.box{
  background-color: rgb(79 83 86 / 35%);
  padding-bottom: 15px;
  margin-left: 23%;
  margin-right: 27%;
  margin-top:  18%;
...
<body style="color: black;background-image: url(H3.jpg);background-size: 100%;background-repeat: no-repeat;back">
 ...
 <div class="box">
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"  ><h1 style="color:white; font-weight: 750">HQ Id</h1></label>
  ...
  <div class="form-group" style="width:30%">
    <label for="exampleInputPassword1"><h1 style="color:white; font-weight: 750">Password</h1></label>
