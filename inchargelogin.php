...
.box{
  ...
  margin-left: 25%;
  margin-right: 25%;
  box-shadow: 0px 0px 5px 0px #647d89;
}
</style>
</head>
<body style="color: black;background-image: url(s3.jpg);background-size: 100%;background-repeat: no-repeat;back">
  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="inchargelogin.php">Supervisor Login</a></li>
 ...
 <div class="box">
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"  ><h1 style="color:black; font-weight: 750;">Supervisor Id</h1></label>
  ...
  <div class="form-group" style="width:30%">
    <label for="exampleInputPassword1"><h1 style="color:black; font-weight: 750">Password</h1></label>
