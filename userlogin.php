...
<body style="background-size: cover;
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="home.php" style="margin-top: 5%;"><b>Online Crime Portal</b></a>
    </div>
...
" >
 <div class="box">
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"><h1 style="color:black; font-weight: 750;">User Id</h1></label>
