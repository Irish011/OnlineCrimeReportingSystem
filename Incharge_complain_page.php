...
<body style="background-color: #b4b4b4">
  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li ><a href="inchargelogin.php">Supervisor Login</a></li>
        <li class="active"><a href="Incharge_complain_page.php">Supervisor Home</a></li>
      </ul>
 ...
 <div style="padding:50px;">
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>2021 Online Crime Portal | All Right Reserved</b></h4>
</div>
